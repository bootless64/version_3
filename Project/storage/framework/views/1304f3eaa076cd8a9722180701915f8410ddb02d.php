...
<?php $__env->startSection('style'); ?>
    ...
    <?php else: ?>
        <link href="<?php echo e(asset('css/home.css')); ?>?v=<?php echo e(filemtime(config('app.server_css_files_path') . '/home.css')); ?>" rel="stylesheet">
    <?php endif; ?>
<?php $__env->stopSection(); ?>
            ...
            <div class="carousel-inner">
                <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                        <img src="<?php echo e(asset('storage/sliders/' . $slide->image)); ?>" class="w-100 h-100" alt="slide <?php echo e($index); ?>">
                        <?php if($slide->title || $slide->description || $slide->button_text): ?>
                            <div class="carousel-caption">
                                <h3><?php echo e($slide->title); ?></h3>
                                <p class="d-sm-block d-none px-5"><?php echo e($slide->description); ?></p>
                                <a href="<?php echo e($slide->button_link); ?>" class="btn btn-primary"><?php echo e($slide->button_text); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card shadow-lg">
                        <img src="<?php echo e(asset('images/cyber-security-10.jpg')); ?>" class="card-img-top" alt="پیش ارزیابی">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card shadow-lg">
                        <img src="<?php echo e(asset('images/training-1.jpg')); ?>" class="card-img-top" alt="پیش تست امنیتی و نفوذ">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card shadow-lg">
                        <img src="<?php echo e(asset('images/seminar-1.jpg')); ?>" class="card-img-top" alt="پایش استانداردها">
                        <div class="card-body">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\2\ASA\version_3\Project\resources\views/home.blade.php ENDPATH**/ ?>