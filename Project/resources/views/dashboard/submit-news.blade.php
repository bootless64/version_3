...
@section('dashboard_content')
    ...
    <div class="container p-4 mb-4">
        ...
        <form method="POST" action="{{ route('dashboard.submit-news.store') }}" enctype="multipart/form-data" onsubmit="return confirm('آیا از ثبت این خبر مطمئن هستید؟');">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="slider_images[]" class="form-label">تصاویر اسلایدر</label>
                <input type="file" name="slider_images[]" id="slider_images[]" class="form-control" multiple accept="image/*">
            </div>

            <div class="d-flex">
                <button type="submit" class="btn btn-primary mx-auto">ثبت خبر</button>
            </div>
        </form>
